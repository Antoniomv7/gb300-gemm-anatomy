...
* P2.3 (joint sweep infrastructure) is implemented, independently audited,
  ...
  independently audited, and verified on GB300 by campaign
  `20260805T102759Z` (see `src/compute/P2_4_PROTOCOL.md`).
